    ...
    def keyboard_callback(self, key):
        try:
            ...
            if key.char == "p":
                ...
                with open("learning/config_files/F1_start_state/"  + f"qpos_start_state.pkl", "wb") as file:
                    pickle.dump(self.data.qpos[:], file)



                # Save the memory to a pickle file
                with open( "learning/config_files/F1_start_state/" + f"qvel_start_state.pkl", "wb") as file:
